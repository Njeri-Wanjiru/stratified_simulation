...
```{r echo=FALSE, warning=FALSE, message=FALSE, cache=FALSE}
ylim_range <- range(c(neyman_mse_set[1:3], wang_mse_set[1:3]+0.1, proposed_mse_set[1:3]))  
...
lines.default(c(3,5,8), wang_mse_set[1:3] + 0.1, col = "brown")
...
```{r echo=FALSE, warning=FALSE, message=FALSE, cache=FALSE}
ylim_range <- range(c(neyman_mse_set[4:6], wang_mse_set[4:6]+0.01, proposed_mse_set[4:6]))  
